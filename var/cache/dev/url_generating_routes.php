...
return [
    'add_gateway' => [[], ['_controller' => 'App\\Controller\\GatewayController::addGateway'], [], [['text', '/addGateway']], [], []],
    ...
    'UpdateJob' => [['name'], ['_controller' => 'App\\Controller\\JobController::UpdateJob'], [], [['variable', '/', '[^/]++', 'name', true], ['text', '/UpdateJob']], [], []],
    'DeleteJob' => [['name'], ['_controller' => 'App\\Controller\\JobController::DeleteJob'], [], [['variable', '/', '[^/]++', 'name', true], ['text', '/DeleteJob']], [], []],
    'add_meter' => [[], ['_controller' => 'App\\Controller\\MeterController::addMeter'], [], [['text', '/addMeter']], [], []],
    'get_one_meter' => [['id'], ['_controller' => 'App\\Controller\\MeterController::getMeter'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/getMeter']], [], []],
    'get_all_meter' => [[], ['_controller' => 'App\\Controller\\MeterController::getAllMeters'], [], [['text', '/getAllMeters']], [], []],
    'delete_meter' => [['id'], ['_controller' => 'App\\Controller\\MeterController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/deleteMeter']], [], []],
    'update_meter' => [['id'], ['_controller' => 'App\\Controller\\MeterController::updateMeter'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/updateMeter']], [], []],
